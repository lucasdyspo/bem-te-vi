...
class content(models.model):
    users = models.ManyToManyField(Usuario, blank=True, related_name='users')
    created_at = models.DateTimeField(auto_now_add=True, blank=True, null=True)
    #image = models.ImageField(upload_to = 'pic_folder/', default = 'pic_folder/None/no-img.jpg')
    textField = models.TextField()
    settings_text = models.CharField(max_length=120, null=True, blank=True)
    
    
    
    
class insertion(models.model):
    user = models.ForeignKey(Usuario, blank=True, null=True, on_delete=models.CASCADE, related_name='user')
    page_art = models.ForeignKey(Art, blank=True, null=True, on_delete=models.CASCADE, related_name='art')
    created_at = models.DateTimeField(auto_now_add=True, blank=True, null=True)
